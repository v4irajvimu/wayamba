<?php if($this->user_permissions->is_view('t_cash_and_card_sales_sum')){ ?>
<link rel="stylesheet" type="text/css" href="<?=base_url()?>css/t_forms.css" />
<script type='text/javascript' src='<?=base_url()?>js/t_cash_and_card_sales_sum.js'></script>
...
<table style="width:100%;" id="tbl1" border="0">
    ...
    <tr>
        ...
        <td>Date</td>
        <td>
        <?php if($this->user_permissions->is_back_date('t_cash_and_card_sales_sum')){ ?>    
    ...
    <tr>
        ...
        <td>&nbsp;</td>
        <input type="hidden" name="type" id="type" title="69" value="69"/>
        <td>Ref No</td>
    ...
    <tr>
        <td colspan="8">
            <table style="width:100%" id="tgrid" border="0" class="tbl">
                        ...
                        <input type='hidden' id='transtype' title='CASH AND CARD' value='CASH AND CARD' name='transtype' />
...
<table border="0" style="width:100%;">
    ...
    <tr>
        <td colspan="7">
            ...
            <?php if($this->user_permissions->is_delete('t_cash_and_card_sales_sum')){ ?><input type="button" id="btnDelete" title="Cancel" /><?php } ?>
            <?php if($this->user_permissions->is_re_print('t_cash_and_card_sales_sum')){ ?><input type="button" id="btnPrint" title="Print" /><?php } ?>
            <input type="hidden" name="srls" id="srls"/>
            <input type='hidden' id='transCode' value='69' title='69'/>
            ...
            <?php if($this->user_permissions->is_add('t_cash_and_card_sales_sum')){ ?><input type="button" title='Save <F8>' id="btnSave"/><?php } ?>
            <input type="button" id="btnApprove" title="Send Approve" />
            

            <span style="margin-left:103px; "><b>Discount Amount</b></span>
        </td>
        <td >
    ...
    <?php 
    if($this->user_permissions->is_print('t_cash_and_card_sales_sum')){ ?>
    ...
    <?php } ?> 
        ...
        <form id="print_pdf" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank">
                 <input type="hidden" name='by' value='t_cash_and_card_sales_sum' title="t_cash_and_card_sales_sum" class="report">
