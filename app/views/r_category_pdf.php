...
error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);
		$this->pdf->setPrintHeader($header,"",$duration);
        ...
        $this->pdf->SetFont('helvetica', 'BI',12);
	 	$this->pdf->Cell(0, 5, 'Main Category Details   ',0,false, 'L', 0, '', 0, false, 'M', 'M');
		$this->pdf->Ln();
        ...
        $this->pdf->Cell(65, 6,"Category", '1', 0, 'C', 0);
        $this->pdf->Cell(45, 6,"Department", '1', 0, 'C', 0);
        
        $count=0;  
        $this->pdf->SetY(41);     
        $pre_count=1;
       foreach ($cat_det as $value) {
        ...
        if($pg_count>1){
            ...
            $this->pdf->MultiCell(45, $heigh,$value->de_code."-". $value->dep,  1, 'L', 0, 1, '', '', true, 0, false, true, 0);
           $count++;
        }
