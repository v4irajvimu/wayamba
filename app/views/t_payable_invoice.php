...
<div class="dframe" id="mframe">
    <form method="post" action="<?=base_url()?>index.php/main/save/t_payable_invoice" id="form_">
        <table style="width: 100%" border="0">
			...
			<tr>
                <td><span style="width: 100px;">Payable Account </span></td>
                ...
                <td><input type="text" class="input_date_down_future" readonly="readonly" name="payable_date" id="payable_date" title="<?=date('Y-m-d')?>" /></td>
          ...
          <tr>
                <td colspan="4" style="text-align: center;">
                    ...
                    <table style="width: 875px;" id="tgrid">
                        <thead>
                            <tr>
                                <th class="tb_head_th" style="width: 200px;">Expense Account</th>
				...
				$xx=$option->autofill_payable;
                    ...
                    <div style="text-align: left; padding-top: 7px;">
                        ...
                        <?php } ?>
                        <span style="text-align:right;margin-left:316; font-weight: bold;">Total
...
<form id="print_pdf" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank">
    ...
    <input type="hidden" name='by' value='t_payable_invoice' title="t_payable_invoice" class="report">
