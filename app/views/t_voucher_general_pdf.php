...
$this->pdf->SetFont('helvetica', 'B', 16);
		...
		if($orgin_print=="1"){
			$this->pdf->Cell(0, 5,'GENERAL VOUCHER',0,false, $align_h, 0, '', 0, false, 'M', 'M');
		}else{
			$this->pdf->Cell(0, 5,'GENERAL VOUCHER (DUPLICATE) ',0,false, $align_h, 0, '', 0, false, 'M', 'M'); 	
		}
		$this->pdf->Ln();
		$this->pdf->SetFont('helvetica', '', 10);
		$this->pdf->Cell(30, 5, "Voucher No -", '0', 0, 'L', 0);
		$this->pdf->Cell(80, 5, $invoice_no, '0', 0, 'L', 0);
		$this->pdf->Cell(30, 5, "Voucher Type : ", '0', 0, 'L', 0);
		$this->pdf->Cell(20, 5, strtoupper($types), '0', 0, 'L', 0);
		$this->pdf->Ln();

		$this->pdf->Cell(30, 5, 'Description :', '0', 0, 'L', 0);
		$this->pdf->Cell(80, 5,$note, '0', 0, 'L', 0);
		$this->pdf->Cell(30, 5, "Date : ", '0', 0, 'L', 0);
		$this->pdf->Cell(20, 5, $ddate.$save_time, '0', 0, 'L', 0);
		$this->pdf->Ln();
