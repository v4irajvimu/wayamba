       ...
       //$this->pdf->setPrintHeader(true);
		...
		$this->pdf->setY(20);
        	...
        	$this->pdf->SetFont('helvetica', 'IBU',12);
		 	$this->pdf->Cell(0, 5, 'SALES SUMMARY',0,false, 'C', 0, '', 0, false, 'M', 'M');
			...
			$this->pdf->Ln();$this->pdf->Ln();     
		 	...
		 	$this->pdf->Ln();
				//$this->pdf->SetY(45);
                        ...
                        $this->pdf->Cell(20, 6,"Rep", '1', 0, 'C', 0);
						...
						//$this->pdf->SetY(45);
		 				$this->pdf->SetX(45);
						$this->pdf->SetFont('helvetica','B',8);
                        $this->pdf->Cell(20, 6,$value->nno, '1', 0, 'L', 0);
                        $this->pdf->Cell(30, 6,$value->ddate, '1', 0, 'L', 0);
						$this->pdf->Cell(70, 6,$value->name,'1', 0, 'L', 0);
                        $this->pdf->Cell(20, 6,$value->gross_amount, '1', 0, 'R', 0);
                        $this->pdf->Cell(20, 6,$value->additional, '1', 0, 'R', 0);
                        $this->pdf->Cell(20, 6,$value->net_amount, '1', 0, 'R', 0);
                        $this->pdf->Cell(20, 6,$value->rep, '1', 0, 'R', 0);
                        $this->pdf->Cell(20, 6,$value->store, '1', 0, 'R', 0);
                        $this->pdf->Ln();
                        $i++;
