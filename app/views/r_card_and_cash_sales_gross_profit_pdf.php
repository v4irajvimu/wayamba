...
error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);
		...
		$this->pdf->AddPage($orientation,$page);   // L or P amd page type A4 or A3
 		...
 		foreach($branch as $ress){
        	...
        	$this->pdf->SetFont('helvetica', 'BU',10);
		 	$this->pdf->Cell(0, 6, 'CARD & CASH SALES - GROSS PROFIT',0,false, 'L', 0, '', 0, false, 'M', 'M');
			$this->pdf->Ln();
			// $this->pdf->Ln();
			$this->pdf->SetX(16);
			$this->pdf->setY(30);
			...
			//$this->pdf->Ln(3);
		 	 ...
		 	 foreach($r_branch_name as $row){
		       ...
		       $bc_id=$row->bc;
			   	...
			   	$this->pdf->Cell(5, 5,':', '0', 0, 'L', 0);
			   	$this->pdf->SetFont('helvetica', '', 9);
			   	$this->pdf->Cell(120, 5,"$bc_id - $branch_name", '0', 0, 'L', 0);
			   	$this->pdf->Ln();
    ...
    $this->pdf->HaveMorePages($heigh);
		    ...
		    //             }
						...
						$this->pdf->MultiCell(15, $heigh, $value->cost,  1, 'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
						$this->pdf->MultiCell(16, $heigh, $value->price,  1, 'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
						$this->pdf->MultiCell(25, $heigh, $value->cost_value,  1, 'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
						$this->pdf->MultiCell(25, $heigh, $value->price_value,  1, 'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
						$this->pdf->MultiCell(25, $heigh, $value->profit,  1, 'R', false, 1, '', '', true, 0, false, true, $heigh,'M' ,false);
						...
						$this->pdf->SetX(16);
					 	...
					 	$this->pdf->Cell(25, 6, number_format($tot_profit,2), '1', 0, 'R', 0);
					 	



	
	$this->pdf->Output("Card_and_Cash_Sales_Gross_Profit".date('Y-m-d').".pdf", 'I');
