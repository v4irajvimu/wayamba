...
error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);
	    ...
	    $area_name=$_POST['area'];
        	...
        	$this->pdf->SetFont('helvetica', 'BU',10);
		 	$this->pdf->Cell(0, 5, 'HP CLOSED ACCOUNTS SUMMARY',0,false, 'L', 0, '', 0, false, 'M', 'M');
			$this->pdf->Ln();
		...
		if($area_name!=""){
           ...
           else
           {
						...
						$this->pdf->Cell(20, 6,"Agr No.", '1', 0, 'C', 0);
			            ...
			            $this->pdf->MultiCell(20, $heigh,$value->agreement_no, $border=1, $align='L', $fill=false, $ln=0, $x=($this->pdf->GetX()), $y=$this->pdf->GetY(), $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=6, $valign='M', $fitcell=true);
			            ...
			            $this->pdf->MultiCell(15, $heigh,$value->tot_rebate, $border=1, $align='R', $fill=false, $ln=0, $x=($this->pdf->GetX()), $y=$this->pdf->GetY(), $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=6, $valign='M', $fitcell=true);
						...
						$this->pdf->SetX(16);
					 	...
					 	$this->pdf->Cell(15, 6, number_format($net_sum,2), 'TB', 0, 'R', 0);
					 	$this->pdf->Cell(15, 6, number_format($downp_sum,2), 'TB', 0, 'R', 0);
					 	$this->pdf->Cell(15, 6, number_format($interest_sum,2), 'TB', 0, 'R', 0);
					 	$this->pdf->Cell(15, 6, number_format($other_char_sum,2), 'TB', 0, 'R', 0);
					 	$this->pdf->Cell(15, 6, number_format($inst_sum,2), 'TB', 0, 'R', 0);
					 	$this->pdf->Cell(15, 6, $no_of_inst_sum, 'TB', 0, 'R', 0);
