<?php if($this->user_permissions->is_view('t_settu_sales')){ ?>
<link rel="stylesheet" type="text/css" href="<?=base_url()?>css/t_forms.css" />
<script type='text/javascript' src='<?= base_url() ?>js/t_settu_sales.js'></script>
<h2>Seettu Sales</h2>

<table width="100%" border="0">
    <tr>
        <td valign="top" class="content" style="width:500px;" >
        <div class="dframe" id="mframe" style="width:73%; padding-left:10px;padding-right:10px;">
        <form id="form_" method="post" action="<?=base_url()?>index.php/main/save/t_settu_sales" >
            <table border="0" width="80%" >
                <tr>
                   <td style="width:120px;">Load No</td>
                   <td colspan="2">
                        <input type="text" class="input_active" id="load_id" name="load_id" title="" style="width:100px;"/></td>  
                    <td style="width:400px;">&nbsp;</td>
                    <td style="width:100px; text-align:left; padding-left:12px;">No</td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="input_active" id="officer_id" name="officer_id" title="" style="width:100px;"/></td><td>
                        <input type="text" class="hid_value" id="officer_name" title=""  readonly='readonly' style="width:300px;"/>
                    </td>
                    <td>&nbsp;</td>
                    <td style="width:100px;text-align:left; padding-left:12px;">Inv No (Start)</td>
                    <td style="width:100px;">
                        <input type="text" class="input_active_num" name="s_nno" id="s_nno" title="<?=$max_no?>"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="6" style="text-align: center;">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="tb_head_th" style="width: 100px;padding-left:10px;">Amount</th>
                                <th class="tb_head_th" style="width: 50px;padding-left:10px;">INV No</th>
                            </tr>
                            ...
                            <?php
                                ...
                                for($x=0; $x<25; $x++){
                                    echo "<tr>";
                                        echo "<td style=''>
                                              <input type='checkbox' class='cbox' name='check_".$x."' id='check_".$x."' title='1' style='margin-left:25px; '/></td>";
                                        ...
                                        echo "<td><input type='text' class='g_input_amo g_col_fixed' id='7_".$x."' name='7_".$x."' readonly='readonly'style='width:100%;'/></td>";
                                        echo "<td><input type='text' class='g_input_num g_col_fixed ss' id='8_".$x."' name='8_".$x."' readonly='readonly'style='width:100%;'/></td>";
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="width:150px;">
                                <input type="text" class="input_active  g_input_num" readonly="readonly" id="inv_tot" name="inv_tot" title="" style="width:150px;"/>
                            </td>
                            <td style="width:491px;">&nbsp;</td>
                            <td>Net Amount</td>
                            <td>
                                 <input type="text" class="hid_value g_input_amounts" readonly="readonly" id="net" name="net" title="" style="width:108px;"/>
                            </td>
                        </tr>
                        <tr>
                             <td>Memo</td>
                             <td colspan="5"><input type="text" class="input_active" id="memo" name="memo" title="" style="width:462px;"/></td>
                        </tr>
                    </table>
                    </td>
                </tr>
                    ...
                    <div style="text-align: left; padding-top: 7px;">
                        ...
                        <?php if($this->user_permissions->is_delete('t_settu_sales')){ ?><input type="button" id="btnDelete" title="Cancel" /><?php } ?>
                        <?php if($this->user_permissions->is_re_print('t_settu_sales')){ ?><input type="button" id="btnPrint" title="Print" /> <?php } ?>                    
                        <?php if($this->user_permissions->is_add('t_settu_sales')){ ?><input type="button" id="btnSave" title='Save <F8>' /><?php } ?>
                    </div>
    ...
    <?php 
        if($this->user_permissions->is_print('t_settu_sales')){ ?>
        <input type="hidden" name='is_prnt' id='is_prnt' value="1" title="1">
<?php } ?> 
</table>
<form id="print_pdf" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank">
             <input type="hidden" name='by' value='t_settu_sales' title="t_settu_sales" class="report">
