...
<html lang="en">
	...
	<div class="wrapper">
        ...
        <div class="company_wrapper">
        	...
        	<div id="title"> KGC FURNITURE (Pvt)Ltd. </div>
        	...
        	<div class="login_area">
            	 <div class="left"><img src="<?=base_url();?>images/login.png" /></div>
           		 <div class="right">
                     <ul><fieldset><legend><div id="f"> </div> <div id="a"> </div></legend>
                        ...
                        <li>
                        <input type="text" id="txtUserName" title="User Name" value="developer"/>
                        </li>
                        <li><span> Password</span>
                        </li>
                        <li>
                            <input type="password" autocomplete="off" id="txtPassword" title="Password" value="541838"/>
                        </li>
                ...
                <!--         <li>
                         <span> Cluster Code</span>
                            ...
                            <input type="hidden" name='cluster' id='cluster' value='C1' title='C1'/>
