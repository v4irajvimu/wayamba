...
error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);
		...
		// $this->pdf->setY(23);
        	...
        	$this->pdf->SetFont('helvetica', 'BIU',12);
		 	$this->pdf->Cell(0, 6, 'CASH SALES RETURN DETAILS ',0,false, 'L', 0, '', 0, false, 'M', 'M');
			
			// $this->pdf->setY(25);
   //          $this->pdf->Cell(66, 1,"",'T',0, 'L', 0);
            $this->pdf->Ln(); 
        ...
        $this->pdf->HaveMorePages(6);
		 	$this->pdf->SetX(16);
		 	$this->pdf->Cell(25, 1, 'INV No', '0', 0, 'L', 0);
        ...
        $this->pdf->HaveMorePages(6);
			$this->pdf->SetX(16);
		 	$this->pdf->Cell(25, 1, "Customer", '0', 0, 'L', 0);
		 	$this->pdf->Cell(5, 1, " - ", '0', 0, 'L', 0);
        ...
        $this->pdf->HaveMorePages(6);
					  ...
					  $this->pdf->Cell(20, 6, number_format($tot_price,2), '1', 0, 'R', 0);
					 // $this->pdf->Cell(1, 6, "", '0', 0, 'R', 0);
					  $this->pdf->Cell(20, 6, number_format($Goss[$a],2), '1', 0, 'R', 0);
					 // $this->pdf->Cell(1, 6, "", '0', 0, 'R', 0);
					  $this->pdf->Cell(20, 6, number_format($tot_dis,2), '1', 0, 'R', 0);
					  //$this->pdf->Cell(1, 6,"", '0', 0, 'R', 0);
					  $this->pdf->Cell(20, 6, number_format($net[$a],2), '1', 0, 'R', 0);
	...
	$this->pdf->Output("Cash Sales Return Summary".date('Y-m-d').".pdf", 'I');
