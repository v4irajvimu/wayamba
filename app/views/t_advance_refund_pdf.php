...
$this->pdf->SetFont('helvetica', 'B', 16);
		...
		if($orgin_print=="1"){
			$this->pdf->Cell(0, 5,'ADVANCE REFUND',0,false, $align_h, 0, '', 0, false, 'M', 'M');
		}else{
			$this->pdf->Cell(0, 5,'ADVANCE REFUND(DUPLICATE) ',0,false, $align_h, 0, '', 0, false, 'M', 'M');
		}
		...
		$this->pdf->SetFont('helvetica', 'B', 9);
		$this->pdf->Cell(30, 1, 'Refund Sum of' , '0', 0, 'L', 0);
		$this->pdf->SetFont('helvetica', '', 9);
		...
		$this->pdf->Cell(30, 1, "Towards  ", '0', 0, 'L', 0);
		...
		$this->pdf->Cell(30, 1, "", '0', 0, 'L', 0);
		$this->pdf->Cell(30, 1, "", '0', 0, 'L', 0);
		$this->pdf->Cell(35, 1, "Amount Refunded ", '0', 0, 'L', 0);
		...
		$this->pdf->footerSetAdvanceRefund($employee,$additional,$user,$credit_tot,$cash_tot,$cheque_tot);	

		$this->pdf->Output("Advance Refund".date('Y-m-d').".pdf", 'I');
