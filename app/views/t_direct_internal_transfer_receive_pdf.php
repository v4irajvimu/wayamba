...
foreach($sum as $s){
	...
	$t_store=$s->to_store." - ".$s->to_store_des;
	$dt=$s->ddate;
	$memo=$s->memo;
}
...
if($orgin_print=="1"){
	$this->pdf->Cell(0, 5, $r_type.' DIRECT INTERNAL TRANSFER RECEIVE ',0,false, 'C', 0, '', 0, false, 'M', 'M');
}else{
	$this->pdf->Cell(0, 5, $r_type.' DIRECT INTERNAL TRANSFER RECEIVE (Duplicate) ',0,false, 'C', 0, '', 0, false, 'M', 'M');
...
$this->pdf->Cell(30, 1, $f_store, '0', 0, 'L', 0);


$this->pdf->Ln();

$this->pdf->Cell(30, 1, 'To Store', '0', 0, 'L', 0);
$this->pdf->Cell(20, 1, $t_store, '0', 0, 'L', 0);
$this->pdf->Cell(20, 1, "", '0', 0, 'L', 0);
$this->pdf->Cell(1, 1, "", '0', 0, 'L', 0);
$this->pdf->Cell(20, 1, "", '0', 0, 'L', 0);
