<?php
    ...
    error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);
        ...
        foreach($groupS as $gpS){
            ...
            $this->pdf->Cell(180, 1,"Stock In Hand Report  ",0,false, 'L', 0, '', 0, false, 'M', 'M');
            $this->pdf->Ln();
    ...
    $heigh=6*(max(1,$this->pdf->getNumLines($value->description, 40),$this->pdf->getNumLines($row->code, 25)));
