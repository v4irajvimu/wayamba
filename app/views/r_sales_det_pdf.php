...
error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);
    ...
    $this->pdf->Cell(120,6,"Description", '1', 0, 'C', 0);
    $this->pdf->Cell(30, 6,"Purchase price", '1', 0, 'C', 0);
    $this->pdf->Cell(30, 6,"Max Price", '1', 0, 'C', 0);
    $this->pdf->Cell(30, 6,"Min Price", '1', 0, 'C', 0);*/
    ...
    $heigh=6*(max(1,$this->pdf->getNumLines($value->description, 100)));
    ...
    $this->pdf->MultiCell(80, $heigh, $value->description, 1, 'L', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
    $this->pdf->MultiCell(30, $heigh, $value->purchase_price, 1, 'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
