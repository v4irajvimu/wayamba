<?php if($this->user_permissions->is_view('r_area')){ ?>
<script type='text/javascript' src='<?=base_url()?>js/r_area.js'></script>
<h2>Area</h2>
<table width="100%">
    <tr>
        <td valign="top" class="content" style="width:450px;">
            <div class="form" id="form" style="width:450px;">
                <form id="form_" method="post" action="<?=base_url()?>index.php/main/save/r_area" >
                <table>
                    <tr>
                        <td>Code</td>
                        <td>
					...
					<tr>
                        <td colspan="2" style="text-align:right">
                            ...
                            <?php if($this->user_permissions->is_add('r_area')){ ?><input type="button" id="btnSave" title='Save <F8>' /><?php } ?>
