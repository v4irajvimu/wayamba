...
$branch_name="";
	...
	$this->pdf->SetFont('helvetica', 'BU',10);
 	$this->pdf->Cell(0, 5, 'Item Category List  ',0,false, 'L', 0, '', 0, false, 'M', 'M');
	$this->pdf->Ln();
	...
	// $this->pdf->Cell(50, 6," Code", '1', 0, 'L', 0);
	// $this->pdf->Cell(110, 6," Name", '1', 0, 'L', 0);
	// $this->pdf->Ln();
	...
	foreach ($customer as $value) {
		...
		$this->pdf->Cell(50, 6,$value->code, '1', 0, 'L', 0);
		$this->pdf->Cell(110, 6,$value->description,'1', 0, 'L', 0);
		$this->pdf->Ln();
