<?php if($this->user_permissions->is_view('029')){ ?>
...
<script type="text/javascript" src="<?=base_url()?>js/t_cus_credit.js"></script>
<h2 style="text-align: center;">Customer Credit Note</h2>
<div class="dframe" id="mframe" style="text-align: center; width: 650px;">
    <form action="index.php/main/save/t_cus_credit" method="post" id="_form">
        <table style="width: 100%" border="0">
            <tr>
                <td style="width: 80px;">Customer</td>
                <td>
                    <input type="text" class="input_txt" id="scustomers" title="Customer Code" style="width: 100px;" />
                ...
                <td>Cr Account</td>
                <td>
                    <input type="text" class="input_txt acount" name="cr_account" id="cr_account" title="CR Account No" maxlength="25" style="width: 100px;" />
                ...
                <td>Dr Account</td>
                <td>
                    <input type="text" class="input_txt acount" name="dr_account" id="dr_account" title="DR Account No" maxlength="25" style="width: 100px;" />
