<h2 style="text-align: center;">Stock Report(Verification)</h2>
<link rel="stylesheet" href="<?=base_url()?>css/report.css" />
<script type="text/javascript" src="<?=base_url()?>js/r_stock2.js"></script>
<div class="dframe" id="r_view2">
    <fieldset>
        ...
        <!--Type :
        <select id="type">
            <option value="det">Valuation</option>
            <option value="sum">Verification</option>
        </select>-->
    </fieldset>
    <fieldset>
