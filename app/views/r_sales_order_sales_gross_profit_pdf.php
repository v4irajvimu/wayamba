...
error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);
    ...
    $this->pdf->Cell(0, 5, 'Sales Order Sales - Gross Profit  ',0,false, 'L', 0, '', 0, false, 'M', 'M');
    ...
    $this->pdf->Ln(); 
        ...
        $this->pdf->Cell(20, 6,"Cost", '1', 0, 'C', 0);
        $this->pdf->Cell(20, 6,"Sales Price", '1', 0, 'C', 0);
        $this->pdf->Cell(20, 6,"Cost Value", '1', 0, 'C', 0);
        $this->pdf->Cell(20, 6,"Sales Value", '1', 0, 'C', 0);
        $this->pdf->Cell(20, 6,"Sales Profit", '1', 0, 'C', 0);
        $this->pdf->Ln();
    ...
    $this->pdf->HaveMorePages($heigh);
        ...
        $this->pdf->MultiCell(20, $heigh,$value->cost,'1', 'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
        $this->pdf->MultiCell(20, $heigh,$value->price,'1', 'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
        $this->pdf->MultiCell(20, $heigh,$value->cost_val,'1', 'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
        $this->pdf->MultiCell(20, $heigh,$value->sales_val,'1', 'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
        $this->pdf->MultiCell(20, $heigh,$value->profit,'1', 'R', false, 1, '', '', true, 0, false, true, $heigh,'M' ,false);
        ...
        $this->pdf->Cell(105, 6,"", '0', 0, 'R', 0);
        $this->pdf->Cell(20, 6,"Total", '0', 0, 'R', 0);
        $this->pdf->Cell(20, 6,number_format($tot_cost_val,2), 'TB', 0, 'R', 0);
        $this->pdf->Cell(20, 6,number_format($tot_sales_val,2), 'TB', 0, 'R', 0);
        $this->pdf->Cell(20, 6,number_format($tot_profit,2), 'TB', 0, 'R', 0);      
