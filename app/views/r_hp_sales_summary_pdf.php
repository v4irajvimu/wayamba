...
error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);
		...
		$this->pdf->setY(22);
        	...
        	$this->pdf->SetFont('helvetica', 'BU',10);
		 	$this->pdf->Cell(0, 5, 'HIRE PURCHASE SUMMARY',0,false, 'L', 0, '', 0, false, 'M', 'M');
			$this->pdf->Ln();
		...
		$this->pdf->Ln();
           ...
           else
           {
                        ...
                        $net_sum=(float)0;
                        $downp_sum=(float)0;
						$interest_sum=(float)0;
						$other_char_sum=(float)0;
						$inst_sum=(float)0;
						$no_of_inst_sum=(float)0;
                        ...
                        $net_sum+=(float)$value->net_amount;
                        $downp_sum+=(float)$value->down_payment;
						$interest_sum+=(float)$value->interest_amount;
						$other_char_sum+=(float)$value->document_charges;
						$inst_sum+=(float)$value->installment_amount;
						$no_of_inst_sum+=(float)$value->no_of_installments;
						...
						$this->pdf->SetX(12);
					 	...
					 	$this->pdf->Cell(44, 5, "TOTAL", '0', 0, 'C', 0);
					 	$this->pdf->Cell(15, 5, number_format($net_sum,2), '1', 0, 'R', 0);
					 	$this->pdf->Cell(15, 5, number_format($downp_sum,2), '1', 0, 'R', 0);
					 	$this->pdf->Cell(15, 5, number_format($interest_sum,2), '1', 0, 'R', 0);
					 	$this->pdf->Cell(15, 5, number_format($other_char_sum,2), '1', 0, 'R', 0);
					 	$this->pdf->Cell(15, 5, number_format($inst_sum,2), '1', 0, 'R', 0);
					 	$this->pdf->Cell(15, 5, $no_of_inst_sum, '1', 0, 'R', 0);
