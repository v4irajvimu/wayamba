...
<script type="text/javascript" src="<?=base_url()?>js/t_direct_internal_transfer_receive.js"></script>
...
<h2 style="text-align: center;">Direct Internal Transfer Receive</h2>
<div class="dframe" id="mframe" style="padding-right:25px; width: 1280px;">
    <form method="post" action="<?=base_url()?>index.php/main/save/t_direct_internal_transfer_receive" id="form_">
        ...
        <table style="width: 100%" border="0">
            <tr>
                ...
                <td style="width: 100px;">Transfer No</td>
                <td style="width: 450px;">
                    <input type="text" class="input_active_num" name="transfer_no" id="transfer_no" readonly style="width:100px;"/>
                </td>
            ...
            <tr>
                ...
                <td style="width: 450px;" rowspan="0">
                    <input type="text" class="input_txt" name="memo" id="memo"  style="width:353px;">
                   <!--  <textarea class="input_txt" name="memo" id="memo"  cols="2"  style="width:353px;"></textarea> -->
                ...
                <td style="width: 100px;">
                   ...
                   <!--  <?php if($this->user_permissions->is_back_date('t_direct_internal_transfer_receive')){ ?>
                    <?php } else { ?>
            ...
            <tr>
                <td style="width: 100px;">To Stores</td>
                <td style="width: 350px;">
                ...
                <td style="width: 450px;">
                    <input type="hidden"  class="hid_value"  id="location_cl" name="location_cl"/>
                    <input type="hidden"  class="hid_value"  id="location_bc" name="location_bc"/>
                    <input type="hidden"  class="hid_value"  id="location_store" name="location_store"/>
                </td>
            ...
            <td colspan="6"> 
                <table style="width:100%;" id="tgrid" cellpadding="0" border="0">
                    ...
                    for($x=0; $x<25; $x++){
                        ...
                        echo "<td><input type='hidden' class='g_input_amo g_col_fixed icst_".$x."' id='cost_".$x."' name='cost_".$x."' style='width : 100%;'/>
                                  <input type='text' class='g_input_amo g_col_fixed imin_".$x."' id='min_".$x."' name='min_".$x."' style='width : 100%;'/></td>";
               ...
               <tr style="background-color: transparent;">
                ...
                <td colspan="7" style="padding-left : 10px;">
                    ...
                    <!--<?php if($this->user_permissions->is_delete('t_direct_internal_transfer_receive')){ ?><input type="button" id="btnDelete" title="Delete" /><?php } ?> -->
                    <?php if($this->user_permissions->is_re_print('t_direct_internal_transfer_receive')){ ?><input type="button" id="btnPrint" title="Print" /><?php } ?>
                    <input type="hidden" name="type" id="type" title="loading" value="loading"  />
                    <?php if($this->user_permissions->is_add('t_direct_internal_transfer_receive')){ ?><input type="button" id="btnSave" title='Save <F8>' /><?php } ?>
                    <!-- <input type="hidden" name='save_chk' value="0" title="0" id="save_chk" >  -->
                    <input type="hidden" name="srls" id="srls"/>
                    <input type='hidden' id='transCode' name='transCode' value='121' title='121'/>
                </td>
                </tr>
            </tfoot>
        </table>
    ...
    <?php 
    if($this->user_permissions->is_print('t_direct_internal_transfer_receive')){ ?>
...
<form id="print_pdf" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank">
    <input type="hidden" name='by' value='t_direct_internal_transfer_receive' title="t_direct_internal_transfer_receive" class="report">
