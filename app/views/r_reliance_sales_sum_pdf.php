	  ...
	  $des=$cat->description;
		...
		$this->pdf->setY(20);
        	...
        	$this->pdf->SetFont('helvetica', 'BU',10);
		 	$this->pdf->Cell(0, 5, 'RELIANCE SALES SUMMARY',0,false, 'L', 0, '', 0, false, 'M', 'M');
			$this->pdf->Ln();
            $this->pdf->Ln();
            ...
            $this->pdf->Cell(2, 6,"", '0', 0, 'R', 0);
            $this->pdf->Cell(23, 6,number_format($tot_discount,2), 'TB', 0, 'R', 0);
            $this->pdf->Cell(2, 6,"", '0', 0, 'R', 0);
