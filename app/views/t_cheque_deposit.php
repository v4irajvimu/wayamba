<?php if($this->user_permissions->is_view('t_cheque_deposit')){ ?>
<link rel="stylesheet" type="text/css" href="<?=base_url()?>css/t_forms.css" />
<script type="text/javascript" src="<?=base_url()?>js/t_cheque_deposit.js"></script>
<h2 style="text-align: center;">Cheque Deposit</h2>

<div class="dframe" id="mframe">
    <form method="post" action="<?=base_url()?>index.php/main/save/t_cheque_deposit" id="form_">
        <table style="width: 100%" border="0">
            <tr>
                ...
                <?php if($this->user_permissions->is_back_date('t_cheque_deposit')){ ?>
          ...
          <tr>
                <td colspan="4" style="text-align: center;">
                    ...
                    <table style="width: 875px;" id="tgrid">
                        <thead>
                            <tr>
                                ...
                                <th class="tb_head_th">Branch Name</th>
                                ...
                                for($x=0; $x<25; $x++){
                                    echo "<tr>";
                                        echo "<td><input type='hidden' name='h_".$x."' id='h_".$x."' title='0' />
                                                  <input type='text' class='hid_value ' id='0_".$x."' name='0_".$x."'  /></td>";
                                        echo "<td><input type='text' class='hid_value'  id='n_".$x."' name='n_".$x."' style='width:100%' readonly='readonly' maxlength='150'/>
                                                  <input type='hidden' name='bank_".$x."' id='bank_".$x."'/>
                                        </td>";
                                        echo "<td><input type='text' class='hid_value fo' id='1_".$x."' name='1_".$x."' style='width:100%;' />
                                                  <input type='hidden' name='branch_".$x."' id='branch_".$x."'/>
                                        </td>";
                                        ...
                                        echo "<td><input type='text' class='hid_value g_input_amo bl' readonly='readonly' id='4_".$x."' name='4_".$x."' /></td>";
                        ...
                        <tfoot>
                            <tr>
                                 ...
                                 <td style="width: 132px;">
                                    <input type="text" class="g_input_amounts" name="total" id="total" style="width:100px;border: 1px solid #003399;"/>
                                </td>
                            </tr>
                            <tr>
                                 <td></td>
                                 ...
                                 <td style="width: 132px;">
                                    <input type="text" class="g_input_amounts" name="tot_settle" id="tot_settle" style="width:100px;border: 1px solid #003399;"/>
                                </td>
                            </tr>
                            <tr>
                                 <td></td>
                                 ...
                                 <td style="width: 132px;">
                                    <input type="text" class="g_input_amounts" name="tot_balance" id="tot_balance" style="width:100px;border: 1px solid #003399;"/>
                                </td>
                            </tr>
                        </tfoot>
                    ...
                    <div style="text-align: left; padding-top: 7px;">
                        ...
                        <?php if($this->user_permissions->is_delete('t_cheque_deposit')){ ?><input type="button" id="btnDelete" title="Cancel" /><?php } ?>
                        <?php if($this->user_permissions->is_re_print('t_cheque_deposit')){ ?><input type="button" id="btnPrint" title="Print" />  <?php } ?>                     
                        <?php if($this->user_permissions->is_add('t_cheque_deposit')){ ?><input type="button"  id="btnSave" title='Save <F8>' /><?php } ?>

                    </div>
                
                <?php if($this->user_permissions->is_print('t_cheque_deposit')){ ?>
      ...
      <form id="print_pdf" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank">
        ...
        <input type="hidden" name='by' value='t_cheque_deposit' title="t_cheque_deposit" class="report">
