<?php if($this->user_permissions->is_view('r_customer_action')){ ?>
<script type='text/javascript' src='<?=base_url()?>js/r_customer_action.js'></script>
<h2>Customer Action Setup</h2>
<table width="100%" >
    <tr>
        <td valign="top" class="content" style="width: 450px;">
            <div class="form" id="form" style="width: 450px;">
                <form id="form_" method="post" action="<?=base_url()?>index.php/main/save/r_customer_action" >
                <table >
					...
					<tr>
                        <td style="text-align:right" colspan="2">
                            ...
                            <?php if($this->user_permissions->is_add('r_customer_action')){ ?><input type="button" id="btnSave" title='Save <F8>' /> <?php } ?>
