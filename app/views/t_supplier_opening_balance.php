...
<script type="text/javascript" src="<?=base_url()?>js/t_supplier_opening_balance.js"></script>
<?php
if(isset($_GET['print'])){
...
?>
<h2 style="text-align: center;">Supplier Opening Balance</h2>
<div class="dframe" id="mframe">
    <form method="post" action="<?=base_url()?>index.php/main/save/t_supplier_opening_balance" id="form_">
            ...
            <tr>
                ...
                <td colspan="4" style="text-align: center;">
                    <table style="width: 875px;" id="tgrid">
                        <thead>
                            <tr>
                                <th class="tb_head_th" style="width: 80px;">Supplier Code</th>
                                <th class="tb_head_th">Supplier Name</th>
