<?php
    ...
    // set data ------------------------------------------------------------------------------------------
     ...
     // Headings
         ...
         $this->pdf->Cell(40, 6,"Cr Acc Name", '1', 0, 'C', 0);
         $this->pdf->Cell(25, 6,"Dr Acc", '1', 0, 'C', 0);
         $this->pdf->Cell(50, 6,"Dr Acc Name", '1', 0, 'C', 0);
    ...
    // Deatils loop            
         ...
         $this->pdf->Cell(40, 6,$row->cracc_des, '1', 0, 'L', 0);
         $this->pdf->Cell(25, 6,$row->draccId, '1', 0, 'L', 0);
         $this->pdf->Cell(50, 6,$row->dracc_des, '1', 0, 'L', 0);
