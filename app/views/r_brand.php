<?php if($this->user_permissions->is_view('r_brand')){ ?>
<script type='text/javascript' src='<?=base_url()?>js/r_brand.js'></script>
<h2>Brand</h2>
    ...
    <tr>
        <td valign="top" class="content" style="width: 450px;">
            <div class="form" id="form" style="width: 450px;">
                <form id="form_" method="post" action="<?=base_url()?>index.php/main/save/r_brand" >
                <table>
                    <tr>
                        <td>Code</td>
                        <td>
                            <input type="text" class="input_txt" maxlength="10" title='<?=$max_no?>' name="code" id="code"  style="width: 150px; text-transform:uppercase;">
					...
					<tr>
                        <td colspan="2" style="text-align: right;">
                            ...
                            <?php if($this->user_permissions->is_add('r_brand')){ ?><input type="button" id="btnSave" title='Save <F8>' /><?php } ?>
