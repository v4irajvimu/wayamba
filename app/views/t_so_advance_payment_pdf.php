<?php
		...
		if($orgin_print=="1"){
		 	...
		 	$this->pdf->Cell(40, 1, "Receipt No :", '0', 0, 'L', 0);
		 	...
		 	$this->pdf->Cell(40, 1, 'Advance for Sales Order No  :' , '0', 0, 'L', 0);
		 	$this->pdf->Cell(1, 1, $so, '0', 0, 'L', 0);
		 	$this->pdf->Cell(1, 1, '', '0', 0, 'L', 0);
		 	$this->pdf->Cell(1, 1, '', '0', 0, 'L', 0);
		 	$this->pdf->Ln();
		 	$this->pdf->Ln();

		 	$this->pdf->Cell(40, 1, 'Received With Thanks a Sum of  :' , '0', 0, 'L', 0);
