<?php if($this->user_permissions->is_view('m_employee_details')){ ?>
<script type='text/javascript' src='<?=base_url()?>js/m_employee_details.js'></script>
<h2>Employee Details</h2>
<table width="100%">
    <tr>
        <td valign="top" class="content" style="width: 600px;">
            <div class="form" id="form">
                <form id="form_" method="post" action="<?=base_url()?>index.php/main/save/m_employee_details" >
                <table>
                     <tr>
                        <td>Category</td>
                        <td><input type="text" class="input_txt" title='' id="cat_id" name="cat_id" style="width: 100px;" maxlength="10"><input type="text" class="hid_value" title='' id="category_id" style="width:200px;"/></td>
                    </tr>
                    <tr>
                        <td>Code</td>
        ...
        <td class="content" valign="top">
            ...
            <td>
            <form style="padding: 0px; margin: 0px;" id="print_pdf" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank">
                <input type="button" title="Employee List" name="emp_list" id="emp_list">
                <input type="hidden" name='by' value='m_employee_list' title="m_employee_list" >
