<h2 style="text-align: center;">Supplier History</h2>
<link rel="stylesheet" href="<?=base_url()?>css/report.css" />
<script type="text/javascript" src="<?=base_url()?>js/r_supplier_history.js"></script>
<div class="dframe" id="r_view2">
    <fieldset>
        ...
        <!--&nbsp; &nbsp;-->
        &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
        Supplier Code : <input type="text" class="input_txt" id="ssupplier" title="Supplier Code" style="width: 150px;" />
        <input type="hidden" id="supplier" title="0" />
    </fieldset>
    <fieldset>
