...
?>
<h2 style="text-align: center;">Item Dispatch Note</h2>
<div id="permission">
    <div id="massage">
...
<div class="dframe" id="mframe">
    <form method="post" action="index.php/main/save/t_dispatch_note" id="form_">
        <table style="width: 100%" border="0">
            <tr>
              ...
              <td><input type="text" class="input_active_num" name="id" id="id" title=" "/>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" class="input_txt" title='Customer Name' readonly="readonly" id="cus_des"  style="width: 297px;">
                ...
                <td><span style="width: 100px;">
                  <input type="text" class="input_date_down_future" readonly="readonly" name="date" id="date" title="" />
                </span></td>
            </tr>
            <tr>
              <td>Memo</td>
              <td><input name="address" type="text" class="input_txt" id="address"  style="width: 600px;" title='Address' /></td>
                    ...
                    <table style="width: 875px;" id="tgrid">
                        <thead>
                            <tr>
                                ...
                                <th class="tb_head_th" style="width: 270px;">Item Name</th>
                        ...
                        <tfoot>
                            <tr style="background-color: transparent;">
                              <td style="padding-left : 7px;">Officer</td>
                              <td colspan="4" style="padding-left : 10px;">
							  <select>
								<option>Officer 1</option>
							  </select>
                              <input name="trans_des" type="text" class="input_txt" id="trans_des" style="width: 150px; border: 1px dotted #111;" title="Officer" readonly="readonly" /></td>
