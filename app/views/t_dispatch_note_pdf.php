<?php
		...
		if($orgin_print=="1"){
		 	...
		 	$this->pdf->Cell(90, 1, $from." - ".$from_des, '0', 0, 'L', 0);
		 	...
		 	$this->pdf->Cell(90, 1, $to." - ".$to_des, '0', 0, 'L', 0);
        	...
        	$heigh=6*(max(1,$this->pdf->getNumLines($row->description,80)));
			$this->pdf->HaveMorePages($heigh);
			$this->pdf->SetLineStyle(array('width' => 0.1, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0.1, 'color' => array(0, 0, 0)));
			$this->pdf->MultiCell(30, $heigh,$row->item,1, 'L',false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
			$this->pdf->MultiCell(80, $heigh,$row->description,1, 'L',false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
			$this->pdf->MultiCell(30, $heigh,$row->batch_no,1, 'L',false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
			$this->pdf->MultiCell(30, $heigh,$row->dqty,1, 'R',false, 1, '', '', true, 0, false, true, $heigh,'M' ,false);
            ...
            $this->pdf->Ln();
		 	...
		 	$this->pdf->Cell(110, 1, 'Authorized', '0', 0, 'C', 0);
