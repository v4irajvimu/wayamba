...
if($orgin_print=="1"){
$this->pdf->Cell(0, 5, ' RECEIVABLE INVOICE AMOUNT', 0, false, $align_h, 0, '', 0, false, '0', '0');
}else{
$this->pdf->Cell(0, 5, ' RECEIVABLE INVOICE AMOUNT (DUPLICATE)  ', 0, false, $align_h, 0, '', 0, false, '0', '0');   
}
...
$this->pdf->SetFont('helvetica', '', 8);
foreach ($jrn_en_body as $value) {
    $rc_type = $value->receivable_type;
    $rc_dc = $value->payable_dec;
    $rc_dc = $value->receivable_account;
    $rc_acc = $value->receivable_account_dec;
    $date = $value->date;
}
...
$this->pdf->Cell(40, 8, "Account", '1', 0, 'C', 0);
$this->pdf->Cell(90, 8, "Discription", '1', 0, 'C', 0);
$this->pdf->Cell(40, 8, "Amount", '1', 0, 'C', 0);
$this->pdf->Ln();
$totdr = (float) '';
$totcr = (float) '';
foreach ($jrn_en_body as $value) {
    ...
    $this->pdf->Cell(40, 6, "$value->income_account", '1', 0, 'C', 0);
    $this->pdf->Cell(90, 6, "$value->description", '1', 0, 'C', 0);
...
$this->pdf->Cell(90, 5, 'Total', '0', 0, 'C', 0);
