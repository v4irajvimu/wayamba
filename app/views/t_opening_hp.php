<?php if($this->user_permissions->is_view('t_opening_hp')){ ?>
<link rel="stylesheet" type="text/css" href="<?=base_url()?>css/t_forms.css" />
<script type="text/javascript" src="<?=base_url()?>js/t_opening_hp.js"></script>
...
<h2 style="text-align: center;">Opening Hire Purchase</h2>
<div class="dframe" id="mframe">
    <form method="post" action="<?=base_url()?>index.php/main/save/t_opening_hp" id="form_">
        <table style="width: 100%" border="0">
            ...
            <table style="width:100%;margin-bottom:1px;margin-top:1px;">
                <tr>
                    <td colspan="2">
                        <div id="tabs4" style="width:440px">
                            <ul>
                                <li><a href="#tabs-1" >Stores</a></li>
                                <li><a href="#tabs-2" >Genaral</a></li>
                                <?php if($use_settu=="1"){?>
            ...
            <tr>
                <td colspan="4" style="text-align: center;">
                                ...
                                for($x=0; $x<25; $x++){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td class='g_col_fixed'>
                                                ...
                                                <input type='text' style='width:160px;' class='g_input_txt g_col_fixed' id='n_".$x."' name='n_".$x."' readonly='readonly' style='width:100%;'/>
                                        ...
                                        echo "<td class='g_col_fixed'>
                                                ...
                                                <input type='text' style='width:44px;float:right;' class='g_input_num g_col_fixed btt_".$x."' id='6_".$x."' name='6_".$x."' readonly='readonly'/></td>";
                                        echo "<td>
                                ...
                                <td rowspan="0" valign="top">
                                    <table>
                                        <tr>
                                            <td>Free Total</td>
                                            <td>
                                                <input type="text" id="tot_free" name="tot_free" class="hid_value g_input_amounts"  style="margin-left:25px;" readonly='readonly'/>
                                            </td>
                                            <td>Total Amount</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="balto_pay" name="balto_pay" class="g_input_amo input_active"  style="margin-left:25px; width:120px;"/>
                                            </td>
                                            <td>Discount</td>
                                        ...
                                        <tr>
                                            <td>Paid Amount</td>
                                            <td>
                                                <input type="text" id="paidto_amt" name="paidto_amt" class="hid_value g_input_amounts"  style="margin-left:25px;" readonly='readonly'/>
                                            </td>
                                            <td>Net Amount</td>
                    ...
                    <div style="text-align: left; padding-top: 20px;">
                        ...
                        <?php if($this->user_permissions->is_delete('t_opening_hp')){ ?><input type="button" id="btnDelete" title="Delete" /><?php } ?>
                        <?php if($this->user_permissions->is_re_print('t_opening_hp')){ ?><input type="button" id="btnPrint" title="Print" /><?php } ?>                      
                        <?php if($this->user_permissions->is_add('t_opening_hp')){ ?><input type="button"  id="btnSave" title="Save" /><?php } ?>
...
<?php 
if($this->user_permissions->is_print('t_opening_hp')){ ?>
    <input type="hidden" name='is_prnt' id='is_prnt' value="1" title="1">
<?php } ?> 
     <form id="print_pdf" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank">
                  
                 <input type="hidden" name='by' value='t_opening_hp' title="t_opening_hp" class="report">
