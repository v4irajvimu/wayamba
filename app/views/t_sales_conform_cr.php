...
<script type="text/javascript" src="<?=base_url()?>js/t_sales_conform_cr.js"></script>
<?php
if(isset($_GET['id'])){
...
?>
<h2 style="text-align: center;">Credit Sales Conform</h2>
<div id="permission">
    <div id="massage">
...
<div class="dframe" id="mframe">
    <form method="post" action="<?=base_url()?>index.php/main/save/t_sales_conform_cr" id="form_">
