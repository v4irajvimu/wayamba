...
<script type='text/javascript' src='<?=base_url()?>js/m_person.js'></script>
<h2>Sales Ref</h2>
<table width="100%">
    <tr>
        <td valign="top" class="content">
            <div class="form" id="form">
                <form id="form_" method="post" action="<?=base_url()?>index.php/main/save/m_person" >
                <table>
                    <tr>
                      <td colspan="2"><input type="radio" name="type" value="3" title="3" /> 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" id="code_" name="code_"title=""/>                        </td>                        
                    </tr><tr>
                        <td>Person Name</td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" class="input_txt" id="p_fax" title="Fax"  name="phone03" style="width: 85px;" maxlength="10" />                        </td>                        
                    </tr>
                    
                    <tr>
                        <td>Date Of Joined</td>
                        <td>
                        <input type="text" class="input_date_down_future" id="dateOfJoin" name='dateOfJoin' title="<?php echo date("Y-m-d"); ?>" id="sd" style="width: 100px;"/>                        </td>                        
                    </tr>
