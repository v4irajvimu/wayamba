...
<script type="text/javascript" src="<?=base_url()?>js/t_cus_debit.js"></script>
<h2 style="text-align: center;">Customer Debit Note</h2>
<div class="dframe" id="mframe" style="text-align: center; width: 650px;">
    <form action="index.php/main/save/t_cus_debit" method="post" id="_form">
        <table style="width: 100%" border="0">
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" name="hcr" id="hcr" title="0" class="input_txt" />
                ...
                <td>Dr Account</td>
                <td>
                    <input type="text" class="input_txt acount" name="dr_account" id="dr_account" readonly="readonly" title="Account No" maxlength="25" style="width: 100px;" />
