...
<script type="text/javascript" src="<?=base_url()?>js/t_sales_credit.js"></script>
<?php
if(isset($_GET['id'])){
    echo "<script type='text/javascript'>
        $('document').ready(function(){

       load_data_by_id(".$_GET['id'].");
...
?>
<h2 style="text-align: center;">Credit Sales</h2>
<div id="permission">
    <div id="massage">
    ...
    <form method="post" action="<?=base_url()?>index.php/main/save/t_sales_credit" id="form_">
        <table style="width: 100%" border="0">
            ...
            <tr>
                <td>Pay Method</td>
               <td colspan="3">
                    <input type="radio" name="pay_method" title="1" disabled="disabled" /> Cash &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="pay_method" title="2" checked="checked" /> Credit &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="pay_method" title="3" disabled="disabled"  /> Easy Payment
                </td>
            </tr>
            <tr>
                <td colspan="4" style="text-align: center;">
                            ...
                            <?php
                                ...
                                for($x=0; $x<25; $x++){
                                    echo "<tr>";
                                        ...
                                        echo "<td><input type='text' class='g_input_num2 qun' id='1_".$x."' name='1_".$x."' autocomplete='off' /></td>";
                                        ...
                                        echo "<td><input type='text' class='g_input_amo dis_pre' style='text-align: right;' id='4_".$x."' name='4_".$x."' autocomplete='off' />
                                            <input type='hidden' class='g_input_amo q' style='text-align: right;' id='44_".$x."' name='44_".$x."' autocomplete='off' readonly='readonly'/>
</td>";
                                        echo "<td><input type='text' class='g_input_amo dis_pre' style='text-align: right;' id='5_".$x."' name='5_".$x."' autocomplete='off' /></td>";
                    ...
                    <div style="text-align: right; padding-top: 7px;">
                        ...
                        <?php } ?>
                        <?php if($this->user_permissions->is_print('024')){ ?>
