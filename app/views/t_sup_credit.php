...
<script type="text/javascript" src="<?=base_url()?>js/t_sup_credit.js"></script>
<h2 style="text-align: center;">Supplier Credit Note</h2>
<div class="dframe" id="mframe" style="text-align: center; width: 650px;">
    <form action="index.php/main/save/t_sup_credit" method="post" id="_form">
