<h2 style="text-align: center;">Credit Limit Grant</h2>
<link rel="stylesheet" href="<?=base_url()?>css/report.css" />
<script type="text/javascript" src="<?=base_url()?>js/r_credit_limit_grant.js"></script>
<div class="dframe" id="r_view2">
    <fieldset>
        <legend>Controls</legend>
        Date : <input type="text" class="input_date_down_future" id="from" title="<?=date('Y-m-d')?>" style="" />
