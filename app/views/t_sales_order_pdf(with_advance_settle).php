<?php
  ...
  $this->pdf->SetFont('helvetica', 'B', 16);
	...
	$this->pdf->setY(23);
 	...
 	$this->pdf->Cell(0, 5, $r_type.'SALES ORDER',0,false, 'C', 0, '', 0, false, 'M', 'M');
 	...
 	$this->pdf->Cell(30, 1, 'Invoice No', '0', 0, 'L', 0);
 	$this->pdf->Cell(10, 1, $inv, '0', 0, 'L', 0);
 	$this->pdf->Cell(10, 1, "", '0', 0, 'L', 0);
...
foreach($det as $row){
	...
	if($code!='default' && $code==$row->item){
		if($row->sub_item!=""){	
	    	$this->pdf->setX(5);	
		  	$this->pdf->SetFont('helvetica','',9);
		  	$aa = $this->pdf->getNumLines($row->des, 42);
	    	$heigh=5*$aa;
			$this->pdf->MultiCell(25, $heigh,$row->sub_item,  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
			$this->pdf->MultiCell(42, $heigh,$row->des,  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
			$this->pdf->MultiCell(25, $heigh,"",  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
			$this->pdf->MultiCell(20, $heigh,"",  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
			$this->pdf->MultiCell(15, $heigh,"",  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
			$this->pdf->MultiCell(15, $heigh,$row->sub_qty,  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
			$this->pdf->MultiCell(18, $heigh,"",  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
			$this->pdf->MultiCell(18, $heigh,"",  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
		...
		$this->pdf->setX(5);
		$this->pdf->SetFont('helvetica','B',9);
		$aa = $this->pdf->getNumLines($row->description, 42);
	    $heigh=5*$aa;
	  	$this->pdf->MultiCell(25, $heigh,$row->item,  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
	  	$this->pdf->MultiCell(42, $heigh,$row->description,  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
	  	$this->pdf->MultiCell(25, $heigh,$row->model,  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
	  	$this->pdf->MultiCell(20, $heigh,$receive,  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
	  	$this->pdf->MultiCell(15, $heigh,$row->batch_no,  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
	  	...
	  	$this->pdf->MultiCell(18, $heigh,$row->discount,  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
    ...
    $this->pdf->setX(5);	
		...
		$this->pdf->SetFont('helvetica','',9);
	    $aa = $this->pdf->getNumLines($all_serial, 42);
	  	$heigh=5*$aa;

	  	$this->pdf->MultiCell(25, $heigh,"",  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
	  	$this->pdf->MultiCell(42, $heigh,$all_serial,  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
	  	$this->pdf->MultiCell(25, $heigh,"",  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
	  	$this->pdf->MultiCell(20, $heigh,"",  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
