            ...
            <td valign="top" class="content" style="width: 640px;">
                <div class="form" id="form">
                    <form id="form_" method="post" action="<?=base_url()?>index.php/main/save/m_customer" >
                        <input type="hidden" name='show_type' id='show_type' title="<?=$show_type?>">
                        <div id="tabs">
                            <ul>
                                <li><a href="#tabs-1">Main</a></li>
                                <? if($show_financial_details==1){ ?><li><a href="#tabs-2">Financial And Other</a></li><? }else{?><li style="display:none;"><a href="#tabs-2"></a></li><? } ?>
                                <? if($show_black_list==1){ ?><li><a href="#tabs-3">Black List</a></li><? }else{?><li style="display:none;"><a href="#tabs-3"></a></li><? } ?>
                                <? if($show_event==1){ ?><li><a href="#tabs-4">Events</a></li><? }else{?><li style="display:none;"><a href="#tabs-4"></a></li><? } ?>
                            ...
                            <div id="tabs-1">
                                <fieldset>
                                    ...
                                    <table border="0" style="width:100%;">
                                        ...
                                        <tr>
                                            <td>NIC</td>
                                            <td><input type="text" class="input_txts" title='' id="nic" name="nic"  style="width:150px;" maxlength="12"/>
                                                ...
                                                <td><input type="checkbox" class='is_type' title="1" id="is_customer" name="is_customer">Is Customer
                                                    ...
                                                    <tr>
                                                        <td>Title</td>
                                                        <td colspan="3">
                                                            <select name='name_title' id='name_title' class='input_txt'>
                                                    ...
                                                    <tr>
                                                        <td>Surname</td>
                                                        <td colspan="3"><input type="text" class="input_txt fn" title='' id="sur_name" name="sur_name"  style="width:430px;" maxlength="100"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Other Names</td>
                                                        <td colspan="3"><input type="text" class="input_txt fn" title='' id="other_name" name="other_name"  style="width:430px;" maxlength="100"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Initials</td>
                                                        <td colspan="3"><input type="text" class="input_txts fn" title='' id="initials" name="initials"  style="width:430px;" maxlength="100"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Full Name</td>
                                                        <td colspan="3"><input type="text" class="input_txt fn" title='' id="f_name" name="f_name"  style="width:430px;" maxlength="100"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Print Name</td>
                                                        <td colspan="3">
                                                            <input type="text" class="hid_value input_txt" title='' id="name" name="name"  style="width:430px;" maxlength="100"  />
                                                            <input type="checkbox" id='edit_name'> Edit Name
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Company Name</td>
                                        ...
                                        <? }else{ ?>
                                        <input type ="hidden" class="input_txt" id="email" title="" style="width:200px" name="email"  maxlength="50"/>
                                        <? } ?>
                                        

                                        <tr>
                                            <td>Postal Code</td>
                                            <td colspan="3"><input type ="text" class="input_active_num" id="po_code" title="" style="width:200px" name="po_code"  maxlength="50"/></td>
                                        </tr>
                            ...
                            <? }else{ ?>
                            <input type="hidden" class="input_date_down_old" title="<?php echo date("Y-m-d"); ?>" id="doj" style="width: 150px;" name="doj" />
                            <? } ?>
                            ...
                            <? }else{ ?>
                            <input type="hidden" id="category_id" class="input_active" title="" name="category_id" />   
                            <? } ?>
                            ...
                            <? }else{ ?>
                            <input type="hidden" id="town_id" class="input_active" title="" name="town_id" />    
                            <? } ?>
                            ...
                            <? }else{ ?>
                            <input type="hidden" id="area_id" class="input_active" title="" name="area_id" />
                            <? } ?>
                            ...
                            <? }else{ ?>
                            <input type="hidden" id="root_id" class="input_active" title="" name="root_id" /> 
                            <? } ?>

                            <?if($show_nationality==1){?>
                            <tr>
                                <td>Nationality</td>
                            ...
                            <? }else{ ?>
                            <input type="hidden" id="nationality_id" class="input_active" title="" name="nationality_id" /> 
                            <? } ?>
                            <tr>
                                <td>Customer Status</td>
                                <td colspan="3"> 
                                    <input type="text" id="cus_status" name="cus_status" class="input_active">
                                    <input type="text" title="" class ="hid_value" id="hid_cus_status" name="hid_cus_status" style="width:280px;"/>
                                    <input type="hidden" id="color_value" name="color_value">
                                    <input type="button" id="btn_cus_status" name="btn_cus_status" title="..."/>
                                </td>
                            </tr>
