...
class t_dispatch_note extends CI_Model {
  ...
  public function load(){
    ...
    //$this->db->where('t_dispatch_sum.type',13);
    ...
    //$this->db->where('t_dispatch_det.type',13);
    ...
    //  $this->db->select(array('t_dispatch_sum.store_from'));
  ...
  public function item_list_all(){
    ...
    public function PDF_report(){
      ...
      $this->db->select(
                  ...
                  't_dispatch_sum.memo',
                  't_dispatch_sum.ddate',
                  's1.description As to_store',
                  's2.description As from_store'
                  ));
      ...
      $this->db->join('t_dispatch_sum','t_dispatch_det.nno=t_dispatch_sum.nno');
      $this->db->join('m_employee','m_employee.code=t_dispatch_sum.officer');
      $this->db->join('m_stores s1','s1.code=t_dispatch_sum.store_to');
      $this->db->join('m_stores s2','s2.code=t_dispatch_sum.store_from');
      $this->db->where('t_dispatch_det.nno',$_POST['qno']);
      $this->db->where('t_dispatch_det.cl',$this->sd['cl']);
      $this->db->where('t_dispatch_det.bc',$this->sd['branch'] );
      $this->db->where('t_dispatch_sum.cl',$this->sd['cl'] );
      $this->db->where('t_dispatch_sum.bc',$this->sd['branch'] );
      ...
      if($s_time==1){
      $r_detail['save_time']="  -  ".$this->utility->get_save_time('t_dispatch_sum','action_date',$_POST['qno'],'nno');
