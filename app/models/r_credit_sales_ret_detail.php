...
class r_credit_sales_ret_detail extends CI_Model{
     ...
     public function PDF_report(){
		  ...
		  */
          ...
          $query1=$this->db->query('SELECT `t_sales_return_sum`.`gross_amount` as gsum , `t_sales_return_sum`.`net_amount` as nsum
            ...
            LEFT JOIN `t_sales_return_det` ON `t_sales_return_sum`.`nno`=`t_sales_return_det`.`nno` AND `t_sales_return_sum`.`cl`=`t_sales_return_det`.`cl` AND `t_sales_return_sum`.`bc`=`t_sales_return_det`.`bc`
          ...
          $query = $this->db->query('SELECT `t_sales_return_sum`.`nno`, 
    			...
    			FROM `t_sales_return_sum`
    			LEFT JOIN `t_sales_return_det` ON `t_sales_return_det`.`nno` = `t_sales_return_sum`.`nno` AND `t_sales_return_sum`.`cl`=`t_sales_return_det`.`cl` AND `t_sales_return_sum`.`bc`=`t_sales_return_det`.`bc`
