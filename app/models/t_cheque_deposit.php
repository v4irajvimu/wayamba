...
class t_cheque_deposit extends CI_Model {
  ...
  public function account_update($condition){
    ...
    $this->account->set_value2("CHEQUE DEPOSIT", $_POST['tot_settle'], "dr", $_POST['banck_acc'],$condition);
  ...
  public function PDF_report(){
   ...
   if($s_time==1){
    $r_detail['save_time']="  -  ".$this->utility->get_save_time('t_cheque_deposit_sum','action_date',$_POST['qno'],'nno');
