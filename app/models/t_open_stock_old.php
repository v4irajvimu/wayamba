...
class t_open_stock extends CI_Model {
                          ...
                          if(isset($_POST['0_'.$x],$_POST['1_'.$x])){
                            if($_POST['0_'.$x] != "" && $_POST['1_'.$x] != "" ){
                              if($this->utility->is_batch_item($_POST['0_'.$x])){
                                if($this->utility->batch_in_item_batch_tb($_POST['0_'.$x],$this->utility->get_batch_no($_POST['0_'.$x],$_POST['2_'.$x],$_POST['max_'.$x],$_POST['min_'.$x]))){
                                  $this->load->model('utility');
                                    ...
                                    $this->utility->insert_batch_items(
                                        ...
                                        2,
                                        $this->max_no,
                                        $this->utility->get_batch_no($_POST['0_'.$x],$_POST['2_'.$x],$_POST['max_'.$x],$_POST['min_'.$x]),
                                        $_POST['2_'.$x],
                                        $_POST['min_'.$x],
                                        $_POST['max_'.$x],
    ...
    public function item_list_all() {
        ...
        $sql = "SELECT * FROM m_item WHERE (description LIKE '%$_POST[search]%' OR code LIKE '%$_POST[search]%' OR model LIKE '%$_POST[search]%' OR m_item.`min_price` LIKE '%$_POST[search]%' OR m_item.`max_price` LIKE '%$_POST[search]%') AND inactive='0' LIMIT 25";
    ...
    $r_detail['session'] = $session_array;
      ...
      $r_detail['serial'] = $this->db->get()->result();
        ...
        if($s_time==1){
            $r_detail['save_time']="  -  ".$this->utility->get_save_time('t_op_stock','action_date',$_POST['qno'],'nno');
