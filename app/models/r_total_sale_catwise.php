...
public function PDF_report(){
    ...
    $cl_flter=" ";
    $bc_flter=" ";
    if (isset($_POST['cluster']) && $_POST['cluster'] != "0") {
      $cl_flter.= " AND ca.`cl`='".$_POST['cluster']."' ";
    }
    if (isset($_POST['branch']) && $_POST['branch'] != "0") {
      $bc_flter.= " AND ca.`bc`='".$_POST['branch']."' ";
    }
    ...
    $sql="SELECT
      ...
      WHERE ca_s.ddate BETWEEN '".$_POST['from']."' AND '".$_POST['to']."' ".$cl_flter." ".$bc_flter."
