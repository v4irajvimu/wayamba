...
class t_privilage_trans extends CI_Model {
   ...
   $p = $this->user_permissions->get_permission($this->mod, array('is_edit', 'is_add'));
        ...
        if($_POST['code_'] == "0" || $_POST['code_'] == ""){
            if($this->user_permissions->is_add('t_privilage_trans')){
        		unset($_POST['code_']);
    	    ...
    	    if($this->user_permissions->is_edit('t_privilage_trans')){
    ...
    public function delete(){
    	if($this->user_permissions->is_delete('t_privilage_trans')){
    	    $this->db->where('code', $_POST['code']);
    	    $this->db->limit(1);
