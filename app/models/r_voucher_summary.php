...
class r_voucher_summary extends CI_Model {
  ...
  //                `cash_amount`
  //               , `cheque_amount`
  //               , `cash_amount`+`cheque_amount` as tot
  //               , `date`
		// , `supplier`
		// , `no`
  //               , `m_supplier`.`name`
  ...
  //               $r->name = "";
  //               $r->cash_amount = "";
  //               $r->cheque_amount = array("data"=>"Total", "style"=>"text-align: right; font-weight: bold; border: none;");
  //               $r->tot = array("data"=>number_format($t, 2, '.', ','), "style"=>"text-align: right; font-weight: bold; border-bottom: 2px solid #000;");
  ...
  //           $cash = array("data"=>"Cash Amount","style"=>"text-align: left; ", "chalign"=>"text-right: left; ");
  //           $cheque = array("data"=>"Cheque Amount", "style"=>"text-align: right; ", "chalign"=>"text-align: right;");
  //           $tot = array("data"=>"Total", "style"=>"text-align: right; ", "chalign"=>"text-align: right;");

  //           $heading = array($vno, $sup,$date,  $cash, $cheque,$tot);
  ...
  //           $cash  = array("data"=>"cash_amount", "total"=>false, "format"=>"text", "style"=>"text-align: center", "chalign"=>"text-align: center");
  //           $cheque  = array("data"=>"cheque_amount", "total"=>false, "format"=>"text", "style"=>"text-align: right", "chalign"=>"text-align: right;");
  //           $tot  = array("data"=>"tot", "total"=>false, "format"=>"text", "style"=>"text-align: right", "chalign"=>"text-align: right;", "limit"=>30);

  //           $field = array($vno, $sup,$date,  $cash, $cheque,$tot);
            
  //           $page_rec = 30;
            
  //           $header  = array("data"=>$this->useclass->r_header("Voucher Summary"), "style"=>"");
