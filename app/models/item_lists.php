...
class item_lists extends CI_Model {
   ...
   $r_detail['type']="itm_lst"; 
    ...
    $supplier=$_POST['supplier'];
      ...
      $sql="SELECT m.`code`,
                  ...
                  b.description AS brand_des 
            FROM  `m_item` m 
            LEFT JOIN `r_category` c  ON m.`category` = c.`code` 
            LEFT JOIN `r_department` d  ON m.`department` = d.`code` 
            LEFT JOIN `r_brand` b  ON m.`brand` = b.`code` 
            WHERE m.code != ''
      ";   
