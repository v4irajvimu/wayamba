  ...
  return $a;
     ...
     public function PDF_report(){
          ...
          if($_POST['sales_category']!="0"){
            ...
            and s.ddate between '".$_POST['from']."' and '".$_POST['to']."' AND s.`is_cancel` !='1' GROUP BY e.`nno`  ORDER BY e.`nno` ASC");
            ...
            WHERE s.ddate between '".$_POST['from']."' and '".$_POST['to']."' 
             $scl1 $sbc1
            AND s.`is_cancel` != '1' GROUP BY e.`nno`  ORDER BY e.`nno` ASC");
            $r_detail['sum']=$query1->result();
            ...
            WHERE s.ddate between '".$_POST['from']."' and '".$_POST['to']."' 
            $scl1 $sbc1
            AND s.`is_cancel` != '1' order by d.`nno` ASC");
            $r_detail['purchase']=$query->result();  
