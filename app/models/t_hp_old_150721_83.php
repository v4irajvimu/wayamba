...
class t_hp extends CI_Model {
  ...
  function __construct(){
    ...
    //$this->max_no= $this->utility->get_max_no("t_hp_sales_sum","nno");
    $this->max_no= $this->t_opening_hp->opening_hp_max_no("1");
  ...
  public function base_details(){
    ...
    $a['stores'] = $this->m_stores->select();
   	$a['max_no']=  $this->t_opening_hp->opening_hp_max_no("1");
  ...
  public function serial_number($type="0")
    {
        ...
        //$res3=$res3+1;
        $res3=$this->t_opening_hp->opening_hp_max_no("1");
        $this->res4 = $res3;
