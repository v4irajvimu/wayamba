...
class r_hp_return_summary extends CI_Model{
  ...
  return $a;
     ...
     public function PDF_report(){
          ...
          $promotion=$_POST['promo'];       
        	...
        	FROM `t_hp_return_sum` s
        	WHERE s.`cl`="'.$this->sd['cl'].'" and s.is_cancel="0" AND s.`bc`= "'.$this->sd['branch'].'"  and s.ddate between "'.$_POST['from'].'" and "'.$_POST['to'].'"');
