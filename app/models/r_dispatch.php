...
class r_dispatch extends CI_Model {
...
//         $sql = "SELECT
//                 `t_dispatch_det`.`item_code`
//                 , `m_items`.`description`
//                 , `t_dispatch_det`.`qty`
//                 , `t_dispatch_det`.`qtyc`
//                 , `t_dispatch_det`.`cartoon`
//                 , `t_dispatch_sum`.`no`
//                 , `t_dispatch_sum`.`date`
// FROM
//     `t_dispatch_det`
//     INNER JOIN `t_dispatch_sum` 
//         ON (`t_dispatch_det`.`id` = `t_dispatch_sum`.`id`)
//     INNER JOIN `m_items` 
//         ON (`t_dispatch_det`.`item_code` = `m_items`.`code`)
...
//                 $heading = array($code,$name,$date,$qty);
...
//                 $field = array($code,$name,$date,$qty);
...
//             $header  = array("data"=>$this->useclass->r_header("Dispatch(Itemwise) Summery report  - ".$this->sd['from']." To ".$this->sd['to']), "style"=>"");
