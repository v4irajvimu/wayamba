...
class r_sales extends CI_Model {
 ...
 //                $heading = array($inv_no, $date, $rn, $job_no, $vehi, $cus, $total,$dis,$net);
 ...
 //                $field = array($inv_no,$date, $rn, $job_no, $vehi, $cus, $total,$dis,$net);
                
 //                $page_rec = 30;
                
 //                $header  = array("data"=>$this->useclass->r_header("Cash Sales Summary Report - ".$this->sd['from']." To ".$this->sd['to']), "style"=>"");
 ...
 //                $heading = array($name, $date, $rn, $code, $foc,$qun, $pri,$dis, $total);
 ...
 //                $field = array($name, $date, $rn, $code, $foc,$qun, $pri,$dis, $total);
                
 //                $page_rec = 28;
                
 //                $header  = array("data"=>$this->useclass->r_header("Cash Sales Detail Report - ".$this->sd['from']." To ".$this->sd['to']), "style"=>"");
 //                $footer  = array("data"=>"<hr />Report generate on - ".date("Y-m-d H:i:s"), "style"=>"font-size: 11px; font-family: Courier;");
 //                $page_no = array("style"=>"font-size: 11px; font-family: Courier;", "vertical"=>"buttom", "horizontal"=>"right");
 ...
 //                $heading = array($inv_no,$date,$rn, $job_no, $vehi, $cus, $cost,$dis,$total);
 ...
 //                $field = array($inv_no,$date,$rn, $job_no, $vehi, $cus,$cost,$dis, $total);
                
 //                $page_rec = 30;
                
 //                $header  = array("data"=>$this->useclass->r_header("Credit Sales Summary Report - ".$this->sd['from']." To ".$this->sd['to']), "style"=>"");
 //                $footer  = array("data"=>"<hr />Report generate on - ".date("Y-m-d H:i:s"), "style"=>"font-size: 11px; font-family: Courier;");
 //                $page_no = array("style"=>"font-size: 11px; font-family: Courier;", "vertical"=>"buttom", "horizontal"=>"right");
 ...
 //                $heading = array($name,$date,$rn, $code, $qun, $pri,$dis, $total);
 ...
 //                $field = array($name,$date,$rn, $code, $qun, $pri,$dis, $total);
                
 //                $page_rec = 28;
                
 //                $header  = array("data"=>$this->useclass->r_header("Credit Sales Detail Report - ".$this->sd['from']." To ".$this->sd['to']), "style"=>"");
 //                $footer  = array("data"=>"<hr />Report generate on - ".date("Y-m-d H:i:s"), "style"=>"font-size: 11px; font-family: Courier;");
 //                $page_no = array("style"=>"font-size: 11px; font-family: Courier;", "vertical"=>"buttom", "horizontal"=>"right");
