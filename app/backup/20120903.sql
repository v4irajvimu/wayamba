...
insert  into `s_users`(`cCode`,`loginName`,`discription`,`userPassword`,`isAdmin`,`bc`,`permission`) values ('1','developer','Soft Master Developer','541838',1,'001',1);
...
insert  into `t_sales_det`(`id`,`item_code`,`cost`,`quantity`) values (1,'001','60.00','45.00');
...
insert  into `t_sales_sum`(`id`,`no`,`date`,`ref_no`,`memo`,`customer`,`sales_ref`,`discount`,`stores`,`so_no`,`bc`,`oc`,`is_cancel`,`action_date`) values (1,1,'2012-09-02','Reference No','Memo','001','001','0.00','001',0,'001','1',0,'2012-09-02 14:45:34');
