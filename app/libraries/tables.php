...
class tables {
    ...
    function __construct(){
        ...
        $this->tb['r_settu_reason'] = 'r_settu_reason';

        $this->tb['chq_print_scheme'] = 'chq_print_scheme';

        $this->tb['chq_account_setup'] = 'chq_account_setup';

        $this->tb['t_job'] = 't_job';
        $this->tb['t_job_send_sum'] = 't_job_send_sum';
        $this->tb['t_job_reject']='t_job_reject';
        $this->tb['t_job_reject_det']='t_job_reject_det';
        ...
        $this->tb['m_guarantor'] = 'm_guarantor';
        ...
        $this->tb['m_vehicle_setup'] = 'm_vehicle_setup';

        $this->tb['m_employee_category'] = 'm_employee_category';

        $this->tb['t_loading_sum'] = 't_loading_sum';

        $this->tb['t_unloading_sum'] = 't_unloading_sum';
        
        $this->tb['m_customer_status'] = 'm_customer_status';

        $this->tb['t_so_sum'] = 't_so_sum';

        $this->tb['t_sales_order_sales_sum'] = 't_sales_order_sales_sum';
        ...
        $this->tb['t_settu_load_sum'] = 't_settu_load_sum';
        ...
        $this->tb['t_seettu_inv_sum'] = 't_seettu_inv_sum';
        ...
        $this->tb['t_seettu_unload_sum'] = 't_seettu_unload_sum';
        ...
        $this->tb['m_hp_sales_category']='m_hp_sales_category';

        $this->tb['m_hp_payment_scheme']='m_hp_payment_scheme';
        ...
        $this->tb['t_voucher_sum'] = 't_voucher_sum';
        ...
        $this->tb['m_settu_item_category']='m_settu_item_category';

        $this->tb['r_hp_chargers_type']='r_hp_chargers_type';

        $this->tb['t_group_sales_budget_sum']='t_group_sales_budget_sum';
