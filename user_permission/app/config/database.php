...
$db['seetha']['username'] = 'softmast_wayamba';
$db['seetha']['password'] = 'wayamba@smtk';
$db['seetha']['database'] = 'softmast_wayamba';
...
$db['default']['username'] = 'softmast_wayamba';
$db['default']['password'] = 'wayamba@smtk';
$db['default']['database'] = 'softmast_wayamba';
