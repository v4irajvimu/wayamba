...
<html>
    ...
    <body>
        <div id="divProgOuter" style='border:0px solid #ccc;padding:0px; top:-10px'>
            <div id="divProgInner" style='width:0px; background-color:#000; color:#fff;padding:0px;height:3px;'></div>            
        </div>
        

        <div id="presentageText" style='z-index:110;font-family:Trebuchet MS;padding-top:10px;padding-right:20px;font-size:55px;text-align:right;width:200px; height:100px;right:0px; top:0px; position:absolute'>
