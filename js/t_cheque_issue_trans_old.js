$(document).ready(function(){
	...
	$("#btnReset").click(function(){
		location.href="index.php?action=t_cheque_issue_trans";
	});
...
function get_data_table(){
    $.post("/index.php/main/load_data/t_cheque_issue_trans/get_data_table", {
...
function check_code(){
        loding();
    var code = $("#code").val();
    $.post("index.php/main/load_data/t_cheque_issue_trans/check_code", {
        code : code
    }, function(res){
        if(res == 1){
