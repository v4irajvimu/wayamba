...
function get_data_table(){
    $.post("/index.php/main/load_data/m_authorization/get_data_table", {
...
function check_code(){
        loding();
    var code = $("#code").val();
    $.post("index.php/main/load_data/m_authorization/check_code", {
        code : code
    }, function(res){
        if(res == 1){
...
function set_delete(code){
    if(confirm("Are you sure delete "+code+"?")){
        loding();
        $.post("index.php/main/delete/m_authorization", {
            code : code
        }, function(res){
            if(res == 1){
                get_data_table();
...
function set_edit(code){
    loding();
    $.post("index.php/main/get_data/m_authorization", {
        code : code
    }, function(res){
        $("#code_").val(res.code);
        $("#code").val(res.code);
