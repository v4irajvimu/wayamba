...
$(document).ready(function(){
    ...
    $("#area, #paper, #root,#sales_ref").change(function(){
        set_session(true);
    ...
    $("#print").click(function(){
        window.open("/index.php/prints/report_forms/r_customer_outstand");
    });
...
function set_session(l){
    $.post("/index.php/main/load_data/loder/report_session", {
        ...
        ref : $("#sales_ref option:selected").val()
    }, function(r){
        if(l){ load_report(); }
    }, "text");
}
...
function load_report(){
    $.post("/index.php/main/load_data/r_customer_outstand/report?echo=true", {
