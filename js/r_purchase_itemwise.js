...
$(document).ready(function(){
    ...
    $("#area, #paper, #from,#to").change(function(){
        set_session(true);
    ...
    $("#print").click(function(){
        window.open("/index.php/prints/report_forms/r_purchase_itemwise");
    });
...
function load_report(){
    $.post("/index.php/main/load_data/r_purchase_itemwise/report?echo=true", {
