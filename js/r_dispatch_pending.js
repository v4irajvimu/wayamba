...
$(document).ready(function(){
    ...
    $("#print").click(function(){
        window.open("/index.php/prints/report_forms/r_dispatch_pending");
    });
...
function load_report(){
    $.post("/index.php/main/load_data/r_dispatch_pending/report?echo=true", {
