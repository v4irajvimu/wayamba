...
$(document).ready(function(){
    ...
    $("#print").click(function(){
        window.open("index.php/prints/report_forms/r_voucher_list");
    });
...
function get_route_list(){
    $.post("index.php/main/load_data/m_root/r_voucher_list", {
...
function load_report(){
    $.post("/index.php/main/load_data/r_age_analyze/report?echo=true", {
