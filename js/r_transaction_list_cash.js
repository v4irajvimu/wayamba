$(document).ready(function(){
  ...
  $("input[type='radio']").click(function(){
    ...
    if(thId=='r_cash_sales_gross_profit'){
      $("#MnTbl").find( "tr" ).show();        
      $("#MnTbl").find( "tr" ).eq(1).hide();
      $("#MnTbl").find( "tr" ).eq(2).hide();

    }else if(thId=='r_cash_sales_summary'){
      $("#MnTbl").find( "tr" ).show();        
      //$("#MnTbl").find( "tr" ).eq(1).hide();
      $("#MnTbl").find( "tr" ).eq(2).hide();
      $("#MnTbl").find( "tr" ).eq(5).hide();
      $("#MnTbl").find( "tr" ).eq(6).hide();
    }else if(thId=='r_cash_sales_details'){
      $("#MnTbl").find( "tr" ).show();        
      //$("#MnTbl").find( "tr" ).eq(1).hide();
      $("#MnTbl").find( "tr" ).eq(2).hide();
      $("#MnTbl").find( "tr" ).eq(5).hide();
      $("#MnTbl").find( "tr" ).eq(6).hide();
    }else if(thId=='r_cash_sales_summary_rep'){
      $("#MnTbl").find( "tr" ).show();        
      //$("#MnTbl").find( "tr" ).eq(1).hide();
      $("#MnTbl").find( "tr" ).eq(2).hide();
      $("#MnTbl").find( "tr" ).eq(5).hide();
      $("#MnTbl").find( "tr" ).eq(6).hide();
    }else if(thId=='r_cash_sales_details_rep'){
      $("#MnTbl").find( "tr" ).show();        
      //$("#MnTbl").find( "tr" ).eq(1).hide();
      $("#MnTbl").find( "tr" ).eq(2).hide();
      $("#MnTbl").find( "tr" ).eq(5).hide();
