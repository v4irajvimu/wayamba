...
function rebeat_settle(){    
    ...
    if(m_round($("#rebeat_capital").val())!="0.00"){
        ...
        $(".ins").each(function(e){ 
        if($("#rcode_"+e).val()=="1"){
            var bal = paid - parseFloat($("#amount_"+e).val());
            var amount = parseFloat($("#amount_"+e).val());
            var balance = parseFloat($("#balance_"+e).val());

            t_amnt += parseFloat($("#amount_"+e).val());
...
function pay_instalment(){    
    ...
    $(".ins").each(function(e){ 
        var bal = paid - parseFloat($("#amount_"+e).val()) + parseFloat($("#rebeat_"+e).val());
        var amount = parseFloat($("#amount_"+e).val()) - parseFloat($("#rebeat_"+e).val());
        var balance = parseFloat($("#balance_"+e).val());
