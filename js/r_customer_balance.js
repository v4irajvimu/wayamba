...
$(document).ready(function(){
    ...
    $("#area, #paper, #root").change(function(){
        set_session(true);
    });
    ...
    $("#print").click(function(){
        window.open("/index.php/prints/report_forms/r_customer_balance");
    });
...
function load_report(){
    $.post("/index.php/main/load_data/r_customer_balance/report?echo=true", {
